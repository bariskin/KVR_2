...
int flag_output_off_on_1;
int flag_output_off_on_2;


IPAddress ip(10,0,0,16);                            //статический IP для МАГНИТ
...
//***********************************
digitalWrite(pin_out_1,HIGH);  // OFF
...
// --------------------------------------- DIGITAL OUTPUT ----------------------------- //
 ...
 if ((flag_output_off_on_1 == 1) && (TRIGGER1_flag == 1))
 {
 ...
 if ((flag_output_off_on_2  == 1) && (TRIGGER2_flag == 1))
 {
